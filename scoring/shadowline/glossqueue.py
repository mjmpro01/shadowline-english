...
Unlike every other queue, the work is a lookup over the network: no file to
download, no ffmpeg, nothing on disk. What it costs is a free dictionary's
daily allowance or a few hundredths of a cent, which is why a finished gloss is
kept for ever and never looked up twice.
...
class GlossQueue:
    ...
    def complete(self, job: GlossJob, said: str, meaning: str, source: str) -> None:
