...
export const en = {
  ...
  // --- login ----------------------------------------------------------------
  'login.tagline': 'pronunciation & rhythm practice, for yourself',
  'login.google': 'Continue with Google',
  'login.only': 'Google is the only way in — there is no password to lose.',
  'login.signingIn': 'Signing you in…',
  'login.error.expired': 'That sign-in took too long. Try again.',
  'login.error.browser': 'Sign-in has to finish in the browser it started in.',
  'login.error.cancelled': 'Sign-in was cancelled.',
  'login.error.failed': 'Google could not sign you in. Try again.',
