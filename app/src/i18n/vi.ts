...
export const vi: Messages = {
  ...
  // --- login ----------------------------------------------------------------
  'login.tagline': 'luyện phát âm và nhịp điệu, cho riêng bạn',
  'login.google': 'Tiếp tục với Google',
  'login.only': 'Chỉ đăng nhập bằng Google — không có mật khẩu nào để quên.',
  'login.signingIn': 'Đang đăng nhập…',
  'login.error.expired': 'Lần đăng nhập đó quá lâu. Thử lại nhé.',
  'login.error.browser': 'Phải đăng nhập xong ngay trong trình duyệt đã bắt đầu.',
  'login.error.cancelled': 'Bạn đã huỷ đăng nhập.',
  'login.error.failed': 'Google không đăng nhập được cho bạn. Thử lại nhé.',
